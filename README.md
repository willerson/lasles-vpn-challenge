# <a href="http://wpemerge.com"><img src="https://docs.wpemerge.com/_images/wpemerge-theme-logo-bar.png" height="61" alt="Fuerza Studio WP Theme Boilerplate Logo" aria-label='WPEmerge.com' /></a>
...
_This is the Fuerza Studio WP Theme Boilerplate project - for the WP Emerge framework please check out https://github.com/htmlburger/wpemerge._
_**WARNING**: Please take a look at the Docs folder to learn a litter bit about what we offer with this theme._
...
- Autoloading for all classes in your `Fuerza\` namespace.
...
Add PHP class files here. All clases in the `Fuerza\` namespace are autoloaded in accordance with [PSR-4](http://www.php-fig.org/psr/psr-4/).
...
Fuerza Studio WP Theme Boilerplate is completely open source and we encourage everybody to participate by:
